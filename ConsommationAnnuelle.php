...
<a class="navbar-brand mr-custom" style="color: #F2A42D;">Electricity</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto ">
                ...
                <li class="nav-item ">
                    <a class="nav-link" style="color: #2DDCE8;" href="ConsommationAnnuelle.php">Annual consumption</a>
                </li>
                <li class="nav-item">
        ...
        <?php foreach ($clients as $row): ?>
          ...
          <td><?= $row["nom"] ?></td>
            ...
            <?php if ($row["difference"] === 'Oui'): ?>
              <a href="NotifieAnnuelle.php?id_client=<?php echo $row["id_client"]; ?>&date=<?php echo $row["annee"]; ?>&prix_ttc=<?php echo $row["prix"]; ?>" class="link-modifier"> <i class="fas fa-bell fa-2x notification-icon"></i></a>
