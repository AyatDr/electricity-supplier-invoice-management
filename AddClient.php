...
if (isset($_POST["submit"])) {
    ...
    try {
        ...
        if ($existing_user) {
            ...
            header("Location: AllClients.php?msg=User already exists");
        } else {
            ...
            header("Location: AllClients.php?msg=New record created successfully");
            exit();
        }
...
<a class="navbar-brand mr-custom" style="color: #F2A42D;">Electricity</a>
    ...
    <div class="container">
        ...
        <p class="text">Fill out the form below to create a new user account</p>
    ...
    <div class="col">
        <input type="text" class="form-control" name="adress" placeholder="Enter Your Adress" required>
    </div>
    </div>
    <div class="row mb-3">
        <div class="col">
        ...
        <div class="col">
            <input type="tel" class="form-control" name="Tel" placeholder="Your phone number" pattern="[0-9]{1,15}" maxlength="15" required>
        </div>
    </div>

    <div class="mb-3">
        <input type="date" class="form-control" name="date" id="date1" required>
    </div>
